...
Q2="SELECT MAX(rank) FROM Movie WHERE year BETWEEN 1983 AND 1994 AND (name LIKE 'Autom%')"
...
Q6="SELECT year FROM Movie WHERE rank==5 Limit 1 OFFSET 0"
